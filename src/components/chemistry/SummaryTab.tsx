...
import { ChapterNotes } from '@/types/chemistry';
...
export default function SummaryTab({ notes }: SummaryTabProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <SummaryCard 
        title="Important Chemical Formulae" 
        content={notes.chapter_chemical_formulae}
        isCode={true}
      />

      <SummaryCard 
        title="Chemical Equations to Remember" 
        content={notes.chapter_chemical_equation}
        isCode={true}
      />
