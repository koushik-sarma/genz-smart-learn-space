...
export function SimulationTab({ chapter }: SimulationTabProps) {
  ...
  const getSimulationFile = (chapterName: string) => {
    const simulations: { [key: string]: string } = {
      ...
      'Quadratic Equations': 'quadratic-equations.html',
      'Arithmetic Progressions': 'arithmetic-progressions.html',
      'Triangles': 'triangles.html',
      'Coordinate Geometry': 'coordinate-geometry.html',
      'Introduction to Trigonometry': 'trigonometry.html',
      'Some Applications of Trigonometry': 'trigonometry-applications.html',
      'Circles': 'circles.html',
      'Areas Related to Circles': 'circle-areas.html',
      'Surface Areas and Volumes': 'surface-areas-volumes.html',
