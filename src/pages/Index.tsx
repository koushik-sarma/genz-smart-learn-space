        ...
        <div className="container mx-auto px-4 py-4 flex justify-between items-center">
          ...
          <div className="flex items-center space-x-4">
            {user ? (
              ...
              <Button 
                variant="ghost" 
                className="text-white border-white/20 bg-purple-600 hover:bg-purple-500 font-bold"
      ...
      <section className="relative z-10 container mx-auto px-4 py-32 text-center">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16">
            <Button 
              size="lg" 
              className="text-xl px-12 py-8 bg-gradient-primary hover:shadow-glow transition-all duration-300 transform hover:scale-105"
        ...
        <div className="container mx-auto px-4 text-center">
          <div className="max-w-4xl mx-auto bg-gradient-to-br from-white/10 to-white/5 backdrop-blur-xl rounded-3xl p-16 border border-white/20 shadow-2xl">
            ...
            <p className="text-2xl text-gray-300 mb-12 max-w-3xl mx-auto">
              Join the AI learning revolution. Start your personalized education journey today — completely free!
            </p>
            ...
            <p className="text-gray-400 text-lg">
              No sign up required • 100% Free • Start learning instantly
            </p>
          </div>
        </div>
      </section>
