      ...
      <div className="relative z-10 p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {chapters.map((chapter) => (
            <Card key={chapter.physic_biology_id} className="bg-white/10 backdrop-blur-xl border-white/20 hover:bg-white/15 transition-all cursor-pointer">
              <CardHeader>
                <div className="text-sm text-green-300 mb-2">Chapter {chapter.physic_biology_id}</div>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="flex justify-end items-center pt-2">
                  <Button 
                    ...
                    onClick={() => navigate(`/biology/chapter/${chapter.physic_biology_id}`)}
                  >
                    Start Learning
                  </Button>
                </div>
