        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="text-white">
              <h1 className="text-3xl font-bold">Social Science - Part 1</h1>
          ...
          <Card className="bg-white/10 backdrop-blur-xl border-white/20 text-center py-12">
            <CardContent>
              ...
              <div className="text-gray-300">
                Social Science Part 1 chapters for your class and board will appear here once they're available.
              </div>
            </CardContent>
          </Card>
        )}
